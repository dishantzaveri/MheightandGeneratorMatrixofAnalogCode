...
# Multi-Scale Exhaustive Random Sampling with reduced search space and iterations
...
# Gradient-Based Refinement with reduced iterations
...
output_task2_file = "Task4pso.pkl"
output_text_file = "Task4pso.txt"
